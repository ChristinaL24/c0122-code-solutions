...
console.log('value of author of second book:', bookshelf[1].author);
console.log('value of isbn of first book:', bookshelf[0].isbn);
console.log('value of title of third book:', bookshelf[2].title);
